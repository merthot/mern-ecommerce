...
const sortOptions = [
    ...
    { name: 'En Çok Satanlar', value: 'best_selling' },
    { name: 'En Çok Değerlendirilenler', value: 'most_rated' },
];

const sizes = ['XS', 'S', 'M', 'L', 'XL', '2XL'];

const colors = [
    { name: 'Beyaz', value: 'white', class: 'bg-white' },
    { name: 'Gri', value: 'gray', class: 'bg-gray-200' },
    { name: 'Siyah', value: 'black', class: 'bg-gray-900' },
...
const ProductFilter = ({
    ...
    const filters = [
        ...
        },
        {
            ...
            name: 'Fiyat Aralığı',
            options: [
                { value: '0-100', label: '0 TL - 100 TL' },
                { value: '100-500', label: '100 TL - 500 TL' },
                { value: '500-1000', label: '500 TL - 1.000 TL' },
                                                            ...
                                                            {section.options.map((option, optionIdx) => (
                                                                ...
                                                                >
                                                                    <input
                                                                        ...
                                                                        type="checkbox"
                                                                        defaultChecked={selectedFilters[section.id]?.includes(
                                                                            option.value
                                                                        )}
                                                                        onChange={(e) =>
                                                                            onFilterChange(
                                            ...
                                            {sortOptions.map((option) => (
                                                <Menu.Item key={option.value}>
                                                    {({ active }) => (
                                                        <button
                                                            onClick={() =>
                                                                onFilterChange('sortBy', option.value, true)
                                                            }
